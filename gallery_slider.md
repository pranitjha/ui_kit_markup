...
<div class="coh-container">
  ...
  <div class="coh-slider-container coh-slider-container-bleed-xl coh-slider-container-overflow-hidden-xl" id="thumbnail-slider-1" role="region">
    <div class="coh-slider-nav-top"></div>
    <div class="coh-slider-container-mid">
      <div class="coh-slider-container-inner slick-initialized slick-slider">
        <div class="coh-slider-nav-inner-top"></div>
        <div class="slick-list">
          <div class="slick-track" style="opacity: 1; width: 1714px; transform: translate3d(-806px, 0px, 0px);">
            <div class="coh-slider-item slick-slide slick-cloned" role="group" data-slick-index="-5" aria-label="slide 1" id="" aria-hidden="true" tabindex="-1" style="width: 100.8px;">
              <img class="coh-image coh-image-responsive-xl" src="/sites/default/files/styles/coh_xx_small_landscape/public/images/default-images/Image-placeholder.png?itok=FO9BH8j1" alt="Placeholder">
            </div>
            <div class="coh-slider-item slick-slide slick-cloned" role="group" data-slick-index="11" aria-label="slide 2" id="" aria-hidden="true" tabindex="-1" style="width: 100.8px;">
              <img class="coh-image coh-image-responsive-xl" src="/sites/default/files/styles/coh_xx_small_landscape/public/images/default-images/Image-placeholder.png?itok=FO9BH8j1" alt="Placeholder">
            </div>
          </div>
        </div>
...
```
<div class="coh-container" aria-roledescription="carousel">
  <div class="coh-slider-container" id="main-slider-1" aria-live="polite/off">
  ...
  <div class="coh-slider-container coh-slider-container-bleed-xl coh-slider-container-overflow-hidden-xl" id="thumbnail-slider-1" role="region">
    ...
    <div class="coh-slider-container-mid">
      <div class="coh-slider-container-inner slick-initialized slick-slider">
        <div class="coh-slider-nav-inner-top"></div> <!-- we can keep either this or the bottom div depeneding on the requirement -->
        <div class="slick-list">
          <div class="slick-track" style="opacity: 1; width: 1714px; transform: translate3d(-806px, 0px, 0px);">
            <div class="coh-slider-item slick-slide slick-cloned" role="group" data-slick-index="-5" aria-label="slide 1" id="" aria-hidden="true" tabindex="-1" style="width: 100.8px;">
              <img class="coh-image coh-image-responsive-xl" src="/sites/default/files/styles/coh_xx_small_landscape/public/images/default-images/Image-placeholder.png?itok=FO9BH8j1" alt="Placeholder">
